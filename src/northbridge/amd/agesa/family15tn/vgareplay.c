...
static uint32_t radeon_delay(uint32_t internal_timer)
{
	radeon_write_sync(0x3f50, 0x0);
	/* Based on a 50MHz internal_timer. YMMV */
	return radeon_read(internal_timer / 50);
}
